...
Built using the [AWS Provider Terraform Modules](https://registry.terraform.io/namespaces/terraform-aws-modules)
...
* AWS cloud native services
  ...
  * etc... 
* AWS VMs
  * _must be "baked" in the AWS Bakery to be available on the AWS API_

## App Layer

The App Layer is the orchestration of applications deployed and running on the Service Layer services.  The App Layer _should not be_ managed in Terraform! There are better solutions for managing App state, Argo, Ansible, Jenkins, etc.
